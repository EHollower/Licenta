...
color_mapping = {
    ...
    'MPM': '#C44E52',
    'Push-Relabel': '#DD8452',
    'Push-Relabel-Highest': '#B33A1B',
    'Push-Relabel-Gap': '#8B2500',
    'Push-Relabel-HG': '#661000',
    'HLPP': '#8172B3',
}

# Mapping for line styles: base vs optimizations
style_mapping = {
    'Edmonds-Karp': 'solid',
    'Scaling': 'dashed',
    'Dinic': 'solid',
    ...
    'MPM': 'solid',
    'Push-Relabel': 'solid',
    'Push-Relabel-Highest': 'dashed',
    'Push-Relabel-Gap': 'dashdot',
    'Push-Relabel-HG': 'dotted',
    'HLPP': 'solid',
}
...
def plotTLEHeatmap(df, alg, out_dir, node_bins=10, edge_bins=10):
    ...
    ax.text(0.5, 1.04, alg, transform=ax.transAxes, ha='center', va='bottom', fontproperties=premium_fp, fontsize=18, color=alg_color)
    ax.text(0.5, 1.00, 'Rata de teste care obțin LTE pe clase de noduri și muchii',
...
def plotCDF(df, algs, out_dir):
    ...
    leg = ax.legend(title='Algoritmi (LTD %)', fontsize=12, title_fontsize=14,
...
print_geometric_mean_ratio(df, 'Edmonds-Karp', 'Dinic')
print_geometric_mean_ratio(df, 'Push-Relabel-HG', 'HLPP')
print_geometric_mean_ratio(df, 'Edmonds-Karp', 'HLPP')